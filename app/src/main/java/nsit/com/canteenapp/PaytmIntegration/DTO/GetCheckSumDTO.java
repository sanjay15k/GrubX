...
public class GetCheckSumDTO {
    ...
    public GetCheckSumDTO(String mId, String channelId, String txnAmount, String website, String callBackUrl,String paytmMerchantKey, String industryTypeId) {
        this.mId = mId;
